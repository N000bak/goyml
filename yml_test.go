...
func TestYml(t *testing.T) {
	...
	offer2 := Offer{
		...
		Model:      "Deskjet D2663",
		Description: OfferDescription{
			Text: "Серия принтеров для людей, которым нужен надежный, простой в использовании цветной принтер для повседневной печати...",
		},
		SalesNotes:           "Необходима предоплата.",
		ManufacturerWarranty: true,
		CountryOfOrigin:      "Япония",
